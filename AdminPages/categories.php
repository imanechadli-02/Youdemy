...
if (isset($_POST['delete'])) {
    if (isset($_POST['catId'])) {
        ...
        $categorie->supprimerCategorie($categorie_id);
        header('location: categories.php');
...
<body class="bg-gradient-to-br from-dark to-surface min-h-screen">
    ...
    <main class="ml-[280px] pt-20 px-8">
            ...
            <div class="flex justify-between items-center gap-4">
                <form action="" method="POST">
                    <div class="flex items-center gap-4">
                        <!-- New Category Input -->
                        <div class="relative">
                            <input name="categorie" type="text" placeholder="Enter new category name..." class="w-64 px-4 py-3 bg-dark/50 border border-white/10 rounded-xl text-gray-100 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-transparent transition-all duration-300">
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <!-- Category Card 1 -->
            <?php foreach ($categoris as $categorie) : ?>
